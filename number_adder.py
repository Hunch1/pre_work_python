# Create a function that will add up all the number in a list of numbers
# Listt of numbers that was given as an argument
...
user_num = input( "tell ne a number?")
print(user_num)
print(type(user_num))
...
a_number = input("Give me a number to your total or type 'quit' to quit")
num_list = []
while a_number != "quit":
